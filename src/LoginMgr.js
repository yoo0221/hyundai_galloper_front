...
function LoginMgr(){
    function loginMgr(){
        ...
        axios
        .post("http://13.125.105.227:8080/manager/login",{
            userId:userId,
            password:password
        })
        .then((response) => {
        ...
        <div>
            ...
            <div class="card m-4">
                <div class="card-body justify-content-center text-center">
                    <h2 className="fw-bold my-5">관리자로 로그인합니다.</h2>
                    ...
                    <button className="form-control login-btn my-5 p-2" onClick={loginMgr}>로그인</button>
                    </div>
                </div>
            </div>
